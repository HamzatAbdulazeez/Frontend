    ...
    <div class="flex flex-col md:flex-row h-screen">
        ...
        <div class="w-full md:w-1/2 p-8 flex flex-col md:pl-20 md:pr-20 pl-4 pr-4 justify-center bg-white">
            ...
            <div class="text-center mb-6">
                ...
                <p class="text-gray-600 text-sm max-w-md mx-auto">Sign in with your email and password</p>
            </div>
                ...
                <form>
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div class="flex items-center">
                            <input type="checkbox" id="remember" class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" required>
                            <label for="remember" class="ml-2 block text-sm text-gray-600">Remember me</label>
                        </div>
                        <div>
                            <a href="{{route('forgot')}}" class="text-sm text-gray-600 hover:text-indigo-600">Forgot password?</a>
                        </div>
                    </div>

                    <!-- Sign In Button -->
                    <div class="mb-6">
                        <button type="submit" class="w-full bg-indigo-600 text-white py-3 rounded-lg hover:bg-indigo-700 transition duration-200">Sign in</button>
                    </div>
                </form>
