    ...
    <div class="flex flex-col md:flex-row h-screen">
        ...
        <div class="w-full md:w-1/2 p-8 flex flex-col md:pl-20 md:pr-20 pl-4 pr-4 justify-center bg-white">
            ...
            <div class="text-center mb-6">
                <h1 class="text-2xl font-bold mb-2">Register as a partner</h1>
                <p class="text-gray-600 text-sm max-w-md mx-auto">Sign up to start amplifying your brand with effective marketing campaigns</p>
            </div>
